...
type GfgGame struct {
	...
	Info        string       `gorm:"column:info;type:character varying(255);not null;comment:游戏简介" json:"info"`                        // 游戏简介
	InfoEn      string       `gorm:"column:info_en;type:character varying(255);not null;comment:游戏英文简介" json:"infoEn"`                 // 游戏英文简介
